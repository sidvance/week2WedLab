////////// PROBLEM 1 //////////
  ...
  const multiply = (num1, num2, fiona) => {
    fiona(num1 * num2)
  }
...
const first = (arr, shrek) => shrek(arr[0])
...
const last = (arr2, donkey) => donkey(arr2[6])
...
const contains = (arr3, name, dragon) => {
  for ( let i = 0; i < arr3.length; i++){
     console.log('I\'m on this step!')
  if (name === arr3[i]) {
    dragon(true)
  }else{ dragon(false)}
}
